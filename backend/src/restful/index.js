...
import { registerArtifactSortRoute, registerCoreSortRoutes } from './sort';
...
export default function serve() {
    ...
    if ($.env.isNode) {
        ...
        host = eval('process.env.SUB_STORE_BACKEND_API_HOST') || '127.0.0.1';
    }
    ...
    registerArtifactSortRoute(configHostingSimpleApps.legacy);
    registerArtifactSortRoute(configHostingSimpleApps.canonical);
